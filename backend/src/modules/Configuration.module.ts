...
@Module({
  imports: [TypeOrmModule.forFeature([EntityConfiguration,EntityService, EntityInvoice]),ServiceModule],
  providers: [ConfigurationService, EmailService, TypeORMExceptions],
  exports: [ConfigurationService,EmailService],
  controllers: [ConfigurationController, EmailController],
})
